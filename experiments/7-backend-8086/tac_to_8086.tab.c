...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_arithmetic = 14,                /* arithmetic  */
  YYSYMBOL_conditional = 15                /* conditional  */
};
...
static const char *const yytname[] =
{
  ...
  "OPERATOR", "ASSIGNOP", "RELOP", "NEWLINE", "$accept", "program",
  "lines", "line", "assignment", "arithmetic", "conditional", YY_NULLPTR
};
...
{
       1,     9,    10,    16,    17,     2,    21,    22,    11,    13,
      14,    19,    15,    18,    20,    23,     0,    12
};
...
{
       0,     3,     8,    10,    11,    12,    13,    14,    15,     6,
       7,     0,    12,     8,     8,     8,     3,     4,     3,     5,
       5,     3,     4,     3
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 9: /* assignment: ID ASSIGNOP ID  */
#line 66 "tac_to_8086.y"
                   {
        strcpy(tac_codes[tac_count].result, (yyvsp[-2].strval));
        strcpy(tac_codes[tac_count].arg1, (yyvsp[0].strval));
        strcpy(tac_codes[tac_count].op, "=");
        tac_count++;
        
        add_symbol((yyvsp[-2].strval));
        add_symbol((yyvsp[0].strval));
    }
#line 1119 "tac_to_8086.tab.c"
    break;

  case 10: /* assignment: ID ASSIGNOP NUMBER  */
#line 75 "tac_to_8086.y"
                         {
        strcpy(tac_codes[tac_count].result, (yyvsp[-2].strval));
        strcpy(tac_codes[tac_count].arg1, (yyvsp[0].strval));
        strcpy(tac_codes[tac_count].op, "=");
...
#line 1132 "tac_to_8086.tab.c"
    break;

  case 11: /* arithmetic: ID ASSIGNOP ID OPERATOR ID  */
#line 86 "tac_to_8086.y"
                               {
        strcpy(tac_codes[tac_count].result, (yyvsp[-4].strval));
        strcpy(tac_codes[tac_count].arg1, (yyvsp[-2].strval));
        strcpy(tac_codes[tac_count].arg2, (yyvsp[0].strval));
        strcpy(tac_codes[tac_count].op, (yyvsp[-1].strval));
        tac_count++;
        
        add_symbol((yyvsp[-4].strval));
        add_symbol((yyvsp[-2].strval));
        add_symbol((yyvsp[0].strval));
    }
#line 1148 "tac_to_8086.tab.c"
    break;

  case 12: /* arithmetic: ID ASSIGNOP ID OPERATOR NUMBER  */
#line 97 "tac_to_8086.y"
                                     {
        strcpy(tac_codes[tac_count].result, (yyvsp[-4].strval));
        strcpy(tac_codes[tac_count].arg1, (yyvsp[-2].strval));
        strcpy(tac_codes[tac_count].arg2, (yyvsp[0].strval));
...
#line 1163 "tac_to_8086.tab.c"
    break;

  case 13: /* arithmetic: ID ASSIGNOP NUMBER OPERATOR ID  */
#line 107 "tac_to_8086.y"
                                     {
        strcpy(tac_codes[tac_count].result, (yyvsp[-4].strval));
        strcpy(tac_codes[tac_count].arg1, (yyvsp[-2].strval));
        strcpy(tac_codes[tac_count].arg2, (yyvsp[0].strval));
...
#line 1178 "tac_to_8086.tab.c"
    break;

  case 14: /* conditional: ID RELOP ID  */
#line 120 "tac_to_8086.y"
                {
...
#line 1193 "tac_to_8086.tab.c"
    break;


#line 1197 "tac_to_8086.tab.c"
