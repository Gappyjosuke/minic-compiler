...
static const char *const yytname[] =
{
  ...
  "FLOAT_CONST", "PLUS", "MINUS", "MUL", "DIV", "LPAREN", "RPAREN",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* program: expr  */
#line 23 "arith_parser.y"
           { printf("Result: %f\n", (yyvsp[0].fval)); }
#line 1072 "arith_parser.tab.c"
    break;

  case 3: /* expr: expr PLUS expr  */
#line 27 "arith_parser.y"
                         { (yyval.fval) = (yyvsp[-2].fval) + (yyvsp[0].fval); }
#line 1078 "arith_parser.tab.c"
    break;

  case 4: /* expr: expr MINUS expr  */
#line 28 "arith_parser.y"
                         { (yyval.fval) = (yyvsp[-2].fval) - (yyvsp[0].fval); }
#line 1084 "arith_parser.tab.c"
    break;

  case 5: /* expr: expr MUL expr  */
#line 29 "arith_parser.y"
                         { (yyval.fval) = (yyvsp[-2].fval) * (yyvsp[0].fval); }
#line 1090 "arith_parser.tab.c"
    break;

  case 6: /* expr: expr DIV expr  */
#line 30 "arith_parser.y"
                         { (yyval.fval) = (yyvsp[-2].fval) / (yyvsp[0].fval); }
#line 1096 "arith_parser.tab.c"
    break;

  case 7: /* expr: LPAREN expr RPAREN  */
#line 31 "arith_parser.y"
                         { (yyval.fval) = (yyvsp[-1].fval); }
#line 1102 "arith_parser.tab.c"
    break;

  case 8: /* expr: INT_CONST  */
#line 33 "arith_parser.y"
                       { (yyval.fval) = (yyvsp[0].fval); }
#line 1108 "arith_parser.tab.c"
    break;

  case 9: /* expr: FLOAT_CONST  */
#line 34 "arith_parser.y"
                       { (yyval.fval) = (yyvsp[0].fval); }
#line 1114 "arith_parser.tab.c"
    break;


#line 1118 "arith_parser.tab.c"
