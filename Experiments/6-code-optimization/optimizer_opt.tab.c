...
static const char *const yytname[] =
{
  ...
  "ASSIGN", "PLUS", "MINUS", "MUL", "DIV", "SEMI", "$accept", "program",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* statement: ID ASSIGN expr SEMI  */
#line 43 "optimizer_opt.y"
    {
        printf("\n=== Optimization Results ===\n");
        printf("Original Code:   %s = ", (yyvsp[-3].id));
        printOptimized((yyvsp[-1].node));
        printf(";\n");

        optimize((yyvsp[-1].node));
        
        printf("Optimized Code:  %s = ", (yyvsp[-3].id));
        printOptimized((yyvsp[-1].node));
        printf(";\n");
        
        freeTree((yyvsp[-1].node));
    }
#line 1098 "optimizer_opt.tab.c"
    break;

  case 4: /* expr: expr PLUS expr  */
#line 60 "optimizer_opt.y"
                       { (yyval.node) = makeNode('+', (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1104 "optimizer_opt.tab.c"
    break;

  case 5: /* expr: expr MINUS expr  */
#line 61 "optimizer_opt.y"
                       { (yyval.node) = makeNode('-', (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1110 "optimizer_opt.tab.c"
    break;

  case 6: /* expr: expr MUL expr  */
#line 62 "optimizer_opt.y"
                       { (yyval.node) = makeNode('*', (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1116 "optimizer_opt.tab.c"
    break;

  case 7: /* expr: expr DIV expr  */
#line 63 "optimizer_opt.y"
                       { (yyval.node) = makeNode('/', (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1122 "optimizer_opt.tab.c"
    break;

  case 8: /* expr: NUMBER  */
#line 64 "optimizer_opt.y"
                       { (yyval.node) = makeLeaf((yyvsp[0].num)); }
#line 1128 "optimizer_opt.tab.c"
    break;

  case 9: /* expr: ID  */
#line 65 "optimizer_opt.y"
                       { (yyval.node) = makeVariable((yyvsp[0].id)); }
#line 1134 "optimizer_opt.tab.c"
    break;


#line 1138 "optimizer_opt.tab.c"
